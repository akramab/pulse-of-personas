...
export const _fullNames = [
  `Apple 2024 Wellness for All Campaign - New York`,
  `Nike 2024 Fitness and Health Initiative - Texas`,
  `Coca-Cola 2024 Refresh and Revitalize Campaign - Florida`,
  `Starbucks 2024 Winter Wellness Drive - California`,
  `Walmart 2024 Family Health Essentials - Illinois`,
  `Target 2024 Community Wellness Campaign - Ohio`,
  `Amazon 2024 Healthy Living Promotion - Georgia`,
  `Adidas 2024 Active Lifestyle Campaign - Washington`,
  `Pepsi 2024 Hydration Awareness Campaign - Colorado`,
  `Google 2024 Digital Health Awareness - New Jersey`,
  `Microsoft 2024 Wellbeing at Work Campaign - Oregon`,
  `Whole Foods 2024 Organic Wellness Drive - Michigan`,
  `CVS 2024 Everyday Health Campaign - Pennsylvania`,
  `Walgreens 2024 Health and Happiness Campaign - Nevada`,
  `Samsung 2024 Smart Wellness Solutions - Arizona`,
  `Bayer 2024 Better Health Campaign - Virginia`,
  `Apple 2024 Digital Health Innovation Campaign - Washington`,
  `Pepsi 2024 Fall Refresh Campaign - Ohio`,
  `Nike 2024 Summer Sports Readiness Campaign - Illinois`,
  `Amazon 2024 Winter Fitness Drive - Florida`,
  `Walgreens 2024 Holiday Health Boost Campaign - California`,
  `Pfizer 2024 Immunity Awareness Campaign - Texas`,
  `Johnson & Johnson 2024 Family Wellness Campaign - New York`,
  `Procter & Gamble 2024 Clean Living Campaign - Colorado`,
];
...
export const _postTitles = [
  ...
  `Sustainable Marketing is the New Competitive Edge`,
  `AI-Driven Personalization is Revolutionizing Brand-Consumer Relationships`,
  `Influencer Marketing 3.0: Brands Are Turning to Virtual Influencers for Authentic Engagement`,
  `Sustainable Marketing is the New Competitive Edge`,
...
export const _sentences = [
  ...
  `With consumers increasingly prioritizing eco-friendly brands, marketers are rethinking their strategies to emphasize sustainability and transparency.`,
  `Companies are leveraging real-time data and machine learning to create hyper-personalized experiences, driving unprecedented consumer engagement.`,
  `As trust in traditional influencers wanes, brands are experimenting with AI-generated personalities to reach younger, tech-savvy audiences.`,
...
export const _campaign = {
  name: 'CVS 2024 Fall and Winter Wellness Campaign - New York',
  purpose: 'Health and Wellness Awareness',
  startDate: 'October 1, 2024 00:00:00',
  endDate: 'November 30, 2024 23:59:59',
  totalBudget: 80000,
  totalEstimatedImpressions: 4000000,
  totalEstimatedClicks: 400000,
  adSets: [
    {
      id: '1',
      name: 'Halloween Night Relief',
      targetSegment: 'Families, young adults, allergy sufferers',
      startDate: 'October 1, 2024 00:00:00',
      endDate: 'October 31, 2024 23:59:59',
      totalBudget: 15000,
      totalEstimatedImpressions: 750000,
      totalEstimatedClicks: 75000,
      ...
      ads: [
        {
          ...
          estimatedClicks: 25000,
          kv: 'Bold, engaging visuals highlighting nasal relief for better sleep',
          kvUrl: 'https://i.imgur.com/EDGSWBm.png',
          primaryText: 'Breathe easy this Halloween season with our nasal strips.',
          headline: 'Halloween Night Relief',
          cta: 'Shop Now',
        },
        {
          id: '2',
          ...
          estimatedClicks: 25000,
          kv: 'Bold, engaging visuals highlighting nasal relief for better sleep',
          kvUrl: 'https://i.imgur.com/i4edUYl.jpeg',
          primaryText: 'Breathe easy this Halloween season with our nasal strips.',
          headline: 'Halloween Night Relief',
          cta: 'Shop Now',
        },
        {
          ...
          estimatedClicks: 25000,
          kv: 'Bold, engaging visuals highlighting nasal relief for better sleep',
          kvUrl: 'https://i.imgur.com/Kk9THZZ.jpeg',
          primaryText: 'Breathe easy this Halloween season with our nasal strips.',
          headline: 'Halloween Night Relief',
          cta: 'Shop Now',
        },
    ...
    {
      id: '2',
      name: 'Election Season Defense',
      targetSegment: 'Adults 30-60, busy professionals, politically engaged users',
      startDate: 'October 1, 2024 00:00:00',
      endDate: 'November 30, 2024 23:59:59',
      totalBudget: 20000,
      ...
      ads: [
        {
          ...
          estimatedClicks: 33333,
          kv: 'Calm, professional visuals highlighting health products for focus and wellness',
          kvUrl: 'https://i.imgur.com/MH3oIHV.png',
          primaryText: 'Stay healthy and focused during election season with trusted wellness.',
          headline: 'Election Season Defense',
          cta: 'Learn More',
        },
        {
          id: '5',
          ...
          estimatedClicks: 33333,
          kv: 'Calm, professional visuals highlighting health products for focus and wellness',
          kvUrl: 'https://i.imgur.com/hb1NLgT.jpeg',
          primaryText: 'Stay healthy and focused during election season with trusted wellness.',
          headline: 'Election Season Defense',
          cta: 'Learn More',
        },
        {
          ...
          estimatedClicks: 33334,
          kv: 'Calm, professional visuals highlighting health products for focus and wellness',
          kvUrl: 'https://i.imgur.com/ukhLmNL.jpeg',
          primaryText: 'Stay healthy and focused during election season with trusted wellness.',
          headline: 'Election Season Defense',
          cta: 'Learn More',
        },
    ...
    {
      id: '3',
      name: 'Effortless Post-Halloween Cleanse',
      targetSegment: 'Young adults, makeup users, Halloween enthusiasts',
      startDate: 'November 1, 2024 00:00:00',
      endDate: 'November 15, 2024 23:59:59',
      totalBudget: 10000,
      ...
      ads: [
        {
          ...
          estimatedClicks: 16667,
          kv: 'Soothing visuals of makeup removal with skincare products',
          kvUrl: 'https://i.imgur.com/dbGXmGo.png',
          primaryText: 'Cleanse easily after Halloween. Gentle makeup removal for all skin types.',
          headline: 'Effortless Post-Halloween Cleanse',
          cta: 'Explore Now',
        },
        {
          id: '8',
          ...
          estimatedClicks: 16667,
          kv: 'Soothing visuals of makeup removal with skincare products',
          kvUrl: 'https://i.imgur.com/lJwLfuI.jpeg',
          primaryText: 'Cleanse easily after Halloween. Gentle makeup removal for all skin types.',
          headline: 'Effortless Post-Halloween Cleanse',
          cta: 'Explore Now',
        },
        {
          ...
          estimatedClicks: 16666,
          kv: 'Soothing visuals of makeup removal with skincare products',
          kvUrl: 'https://i.imgur.com/BZhIxY7.jpeg',
          primaryText: 'Cleanse easily after Halloween. Gentle makeup removal for all skin types.',
          headline: 'Effortless Post-Halloween Cleanse',
          cta: 'Explore Now',
        },
    ...
    {
      id: '4',
      name: 'Fall Skin Rescue',
      targetSegment: 'Teens, young adults, skincare enthusiasts',
      startDate: 'October 1, 2024 00:00:00',
      endDate: 'November 30, 2024 23:59:59',
      totalBudget: 15000,
      totalEstimatedImpressions: 750000,
      ...
      ads: [
        {
          ...
          estimatedImpressions: 250000,
          estimatedClicks: 25000,
          kv: 'Youthful visuals promoting healthy, blemish-free skin',
          kvUrl: 'https://i.imgur.com/dbBl69X.png',
          primaryText: 'Protect and heal your skin this fall. Keep blemishes at bay.',
          headline: 'Fall Skin Rescue',
          cta: 'Browse Now',
        },
        {
          id: '11',
          ...
          estimatedClicks: 25000,
          kv: 'Youthful visuals promoting healthy, blemish-free skin',
          kvUrl: 'https://i.imgur.com/xIAWaMu.jpeg',
          primaryText: 'Protect and heal your skin this fall. Keep blemishes at bay.',
          headline: 'Fall Skin Rescue',
          cta: 'Browse Now',
        },
        {
          ...
          estimatedClicks: 25000,
          kv: 'Youthful visuals promoting healthy, blemish-free skin',
          kvUrl: 'https://i.imgur.com/uziCi8z.jpeg',
          primaryText: 'Protect and heal your skin this fall. Keep blemishes at bay.',
          headline: 'Fall Skin Rescue',
          cta: 'Browse Now',
        },
    ...
    {
      id: '5',
      name: 'Family Wellness for Thanksgiving Prep',
      targetSegment: 'Families, grandparents, adults 40+',
      startDate: 'November 1, 2024 00:00:00',
      endDate: 'November 30, 2024 23:59:59',
      totalBudget: 20000,
      totalEstimatedImpressions: 1000000,
      ...
      ads: [
        {
          ...
          estimatedImpressions: 333333,
          estimatedClicks: 33333,
          kv: 'Heartwarming visuals focused on family health for the holiday season',
          kvUrl: 'https://i.imgur.com/74vhsMO.png',
          primaryText: 'Prepare for Thanksgiving with health checks for you and your family.',
          headline: 'Family Wellness for Thanksgiving',
          cta: 'Check It Out',
        },
        {
          id: '14',
          ...
          estimatedClicks: 33333,
          kv: 'Heartwarming visuals focused on family health for the holiday season',
          kvUrl: 'https://i.imgur.com/McYLFn8.jpeg',
          primaryText: 'Prepare for Thanksgiving with health checks for you and your family.',
          headline: 'Family Wellness for Thanksgiving',
          cta: 'Check It Out',
        },
        {
          ...
          estimatedClicks: 33334,
          kv: 'Heartwarming visuals focused on family health for the holiday season',
          kvUrl: 'https://i.imgur.com/ucXabZj.jpeg',
          primaryText: 'Prepare for Thanksgiving with health checks for you and your family.',
          headline: 'Family Wellness for Thanksgiving',
          cta: 'Check It Out',
        },
