...
export const navData = [
   ...
   */
  {
    ...
    items: [
      ...
      { title: 'Campaigns', path: paths.comingSoon, icon: ICONS.ecommerce },
      { title: 'Ad Analytics', path: paths.comingSoon, icon: ICONS.analytics },
      { title: 'Budgeting', path: paths.comingSoon, icon: ICONS.banking },
      { title: 'Scheduling', path: paths.comingSoon, icon: ICONS.booking },
      { title: 'File', path: paths.comingSoon, icon: ICONS.file },
      { title: 'Guides', path: paths.comingSoon, icon: ICONS.course },
    ],
  },
  /**
   * Management
    ...
    items: [
      {
        ...
        icon: ICONS.user,
        children: [
          { title: 'Profile', path: paths.comingSoon },
          { title: 'Cards', path: paths.comingSoon },
          { title: 'List', path: paths.comingSoon },
          { title: 'Create', path: paths.comingSoon },
          { title: 'Edit', path: paths.comingSoon },
          { title: 'Account', path: paths.comingSoon },
        ],
      },
      {
        title: 'Ad Creatives',
        ...
        children: [
          { title: 'List', path: paths.comingSoon },
          { title: 'Details', path: paths.comingSoon },
          { title: 'Create', path: paths.comingSoon },
          { title: 'Edit', path: paths.comingSoon },
        ],
      },
      ...
      { title: 'Media Library', path: paths.comingSoon, icon: ICONS.folder },
      {
        title: 'Mail',
        path: paths.comingSoon,
        icon: ICONS.mail,
