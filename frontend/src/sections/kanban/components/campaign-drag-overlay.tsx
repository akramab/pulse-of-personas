...
import { CampaignColumnToolBar } from '../column/campaign-column-toolbar';
...
export function CampaignDragOverlay({ columns, tasks, activeId, sx }: KanbanDragOverlayProps) {
...
export function ColumnOverlay({ column, tasks, sx }: ColumnOverlayProps) {
  return (
    <ColumnBase
      slots={{
        header: <CampaignColumnToolBar columnName={column.name} totalTasks={tasks.length} />,
