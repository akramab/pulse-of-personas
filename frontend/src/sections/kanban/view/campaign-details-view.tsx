...
import { CampaignColumn } from '../column/campaign-column';
import { CampaignTaskItem } from '../item/campaign-task-item';
...
import { CampaignDragOverlay } from '../components/campaign-drag-overlay';
          ...
          >
            ...
            >
              {board?.columns.map((column) => (
                <CampaignColumn key={column.id} column={column} tasks={board.tasks[column.id]}>
                  <SortableContext
