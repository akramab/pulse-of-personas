...
type Client interface {
	...
	GetData(ctx context.Context, year int, stateCode StateCode, rangeCode RangeCode) error
}
...
func (c *clientImpl) GetData(ctx context.Context, year int, stateCode StateCode, rangeCode RangeCode) error {
